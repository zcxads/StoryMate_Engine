...
ENGLISH_TRANSLATION_TEMPLATE = """Please translate the following text into English.
...
- CRITICAL: You MUST translate ALL content into English only
- Use proper English grammar and clear sentence structure
- Translate ALL Korean/Japanese/Chinese words and phrases into English
- Maintain the original meaning, details, and logical structure
- Use natural English expressions
- Do NOT keep any foreign language words in the translation
- Ensure 100% of the output is in English language only

**CRITICAL OUTPUT INSTRUCTIONS:**
- Output ONLY the translated text in English
